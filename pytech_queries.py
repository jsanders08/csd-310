...
dave = students.find_one({"student_id": "1008"})
stuart = students.find_one({"student_id": "1009"})

print("\n -- DISPLAYING STUDENT DOCUMENT FROM find_one() QUERY --")
print(" Student ID: " + leroy["student_id"] + "\n First Name: " + leroy["first_name"] + "\n Last Name: " + leroy["last_name"] + "\n")
print(" Student ID: " + dave["student_id"] + "\n First Name: " + dave["first_name"] + "\n Last Name: " + dave["last_name"] + "\n")
print(" Student ID: " + stuart["student_id"] + "\n First Name: " + stuart["first_name"] + "\n Last Name: " + stuart["last_name"] + "\n")
